...
const App = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:3003/api/loan/apply", formData);
  ...
  return (
    <>
      ...
      <section className="py-4 bg-blue">
        <Container>
          <h2 className="text-center mb-5 fw-bold" style={{ color: "#0b2e6b" }}>
            Loan Types
          </h2>
          <Row className="gx-4 justify-content-center">
            ...
            <Col md={3} sm={6} className="mb-4">
              <Card className="h-100 bg-white shadow rounded text-center py-4">
                ...
                <Card.Text className="text-muted">
                  Customized loans for urgent needs
                </Card.Text>
              </Card>
            </Col>
            ...
            <Col md={3} sm={6} className="mb-4">
              <Card className="h-100 bg-white shadow rounded text-center py-4">
                ...
                <Card.Text className="text-muted">
                  Quick financing by discounting bills
                </Card.Text>
              </Card>
            </Col>
          </Row>
            ...
            {[
              ...
              <Col md={3} key={idx} className="mb-4">
                <Card className="shadow-sm border-0 py-4 h-100">
                  <Card.Body>
                    <div style={{ fontSize: "3rem", color: "#0b2e6b" }}>
                      {icon}
                    </div>
                    <Card.Title
      ...
      <section className="py-5 bg-red">
        <Container>
          <Row>
            <Col md={6}>
              <h3 className="mb-4 fw-bold" style={{ color: "#142f61ff" }}>
                ...
                <Row className="g-3 align-items-center">
                  ...
                  <Col xs={9}>
                    <Card.Text className="mb-1" style={{ color: "#333" }}>
                      "SMCL Finance helped me get the loan I needed quickly.
                      Their process was fast and their service was excellent."
                    </Card.Text>
              ...
              <Card className="shadow-sm border-0 mb-4 p-3">
                <Row className="g-3 align-items-center">
                  ...
                  <Col xs={9}>
                    <Card.Text className="mb-1" style={{ color: "#333" }}>
                      "The customer support team at SMCL Finance was excellent!
            ...
            <Col md={6}>
              <h3 className="mb-4 fw-bold" style={{ color: "#0b2e6b" }}>
                Partnered Banks
              </h3>
